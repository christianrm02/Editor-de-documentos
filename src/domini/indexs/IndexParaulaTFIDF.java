...
public class IndexParaulaTFIDF implements Serializable{
    ...
    /**
     * Set amb les paraules que no es guardaran a l'índex
     */
    ...
    /**
     * Mètode per calcular els TFIDFs de totes les paraules de tots els documents de l'índex
     */
    ...
    /**
     * Mètode per llegir les stop words i inicialitzar el set stopWords
     */
    ...
    /**
     * Llista d'stop words en castellà
     */
